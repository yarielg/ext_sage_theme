...
@section('content')
    ...
    <div class="container px-lg-0 mb-8">
        ...
        <div class="row services-tabs">
            ...
            <div class="col-12 col-lg-8 service-body pe-lg-6">
                ...
                <div class="tab-content" id="nav-tabContent">
                    ...
                    <div class="tab-pane fade show active" id="nav-1" role="tabpanel" aria-labelledby="nav-1-tab">
                        @include('partials.industries.industry-tab-overview')
                    </div>

                    @if ($experiences)
                        <div class="tab-pane fade" id="nav-2" role="tabpanel" aria-labelledby="nav-2-tab">
                            @include('partials.industries.industry-tab-experiences')
                        </div>
                    @endif

                    @if ($professionals)
                        <div class="tab-pane fade" id="nav-3" role="tabpanel" aria-labelledby="nav-3-tab">
                            @include('partials.industries.industry-tab-professionals')
                        </div>
                    @endif

                    <div class="tab-pane fade" id="nav-4" role="tabpanel" aria-labelledby="nav-4-tab">
                        @include('partials.industries.industry-tab-news')
                    </div>
            ...
            @include('partials.industries.industry-sidebar')
