...
class IndustrySingle extends Composer
{
    /**
    ...
    {
        return get_field('industry_name');
    }


    public function getHeaderDescription() 
    {
        return get_field('industry_summary');
    }


    public function getHeaderImage()
    {
        $header_image = get_field('industry_hero'); // Returns image array
    ...
    public function getContactProfessionals()
    {
        ...
        $contacts = get_field('industry_professionals');
